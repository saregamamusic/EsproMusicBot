...
from EsproMusic import app  # Updated
...
async def gen_thumb(videoid: str):
    try:
        ...
        arial = ImageFont.truetype("EsproMusic/assets/font2.ttf", 30)  # Updated
        font = ImageFont.truetype("EsproMusic/assets/font.ttf", 30)    # Updated
        title_font = ImageFont.truetype("EsproMusic/assets/font3.ttf", 45)  # Updated
